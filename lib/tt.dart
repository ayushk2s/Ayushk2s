...
class _HomePageState extends State<HomePage>
  ...
  '''Building intelligent systems that merge AI, robotics, and embedded technology. Passionate about coding in C++ and Python, exploring robotics hardware, and innovating in quant trading. Driven to launch impactful companies and design futuristic digital experiences that shape the future.''';
            ...
            child: SingleChildScrollView(
              child: ConstrainedBox(
                constraints: BoxConstraints(
                  maxWidth: isDesktop ? 550 : double.infinity, // ✅ better width on desktop
                ),
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    ...
                    const Text(
                      "Collaborate with me on AI, robotics and futuristic technologies. "
                          "Feel free to message me!",
                      style: TextStyle(height: 1.4),
                    ),
                    const SizedBox(height: 20),

                    // ✅ Instagram / Threads / X / Email Buttons
                    Wrap(
                      spacing: 10,
                      runSpacing: 10,
                      children: [
                        ...
                        _socialButton(
                          Icons.snapchat,
                          'Snapchat',
                          'https://www.snapchat.com/@ayushk2s',
                        ),
                      ],
                    ),
                    ...
                    const SizedBox(height: 12),
                    _inputBox(_messageController, 'Your Message', maxLines: 4),
